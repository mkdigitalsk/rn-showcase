...
export const sk: Record<StringKey, string> = {
  ...
  networking_content: 'Obsah',
  networking_refresh: 'Obnoviť poznámky',
  networking_add: 'Pridať poznámku',
  networking_save: 'Uložiť',
  networking_cancel: 'Zrušiť',
  networking_conflict_title: 'Poznámka sa medzitým zmenila',
  networking_conflict_text: 'Počas úprav niekto uložil inú verziu. Vyberte si, ktorú chcete ponechať.',
  networking_conflict_keep: 'Ponechať moju',
  ...
  // SignIn
  sign_in_title: 'Vitajte',
  sign_in_subtitle: 'Prihláste sa pre pokračovanie',
  sign_in_email_label: 'Email',
  sign_in_email_placeholder: 'Zadajte email',
  sign_in_password_label: 'Heslo',
  sign_in_password_placeholder: 'Zadajte heslo',
  sign_in_button: 'Prihlásiť sa',
  sign_in_fill_test: 'Vyplniť testovací účet',
  sign_in_test_account_hint: 'Testovací účet',
  sign_in_biometric_label: 'Prihlásiť sa biometriou',
  sign_in_biometric_cancelled: 'Autentifikácia zrušená',
  sign_in_email_error_empty: 'Email je povinný',
  sign_in_email_error_invalid: 'Neplatný formát emailu',
  sign_in_password_error_empty: 'Heslo je povinné',
  sign_in_password_error_short: 'Heslo musí mať aspoň 8 znakov',
  sign_in_password_error_weak: 'Heslo musí obsahovať veľké, malé písmeno, číslicu a špeciálny znak',
  sign_in_server_error: 'Nesprávny email alebo heslo',
  sign_in_to_sign_up: 'Nemáte účet? Vytvorte si ho',

  // SignUp
  sign_up_title: 'Vytvorenie účtu',
  sign_up_subtitle: 'Vyplňte údaje pre vytvorenie účtu',
  sign_up_email_label: 'Email',
  sign_up_email_placeholder: 'Zadajte email',
  sign_up_password_label: 'Heslo',
  sign_up_password_placeholder: 'Zadajte heslo',
  sign_up_confirm_label: 'Potvrdiť heslo',
  ...
  sign_up_password_error_empty: 'Heslo je povinné',
  sign_up_password_error_short: 'Heslo musí mať aspoň 8 znakov',
  sign_up_password_error_weak: 'Heslo musí obsahovať veľké, malé písmeno, číslicu a špeciálny znak',
  sign_up_confirm_error_empty: 'Potvrdenie hesla je povinné',
  sign_up_confirm_error_mismatch: 'Heslá sa nezhodujú',
